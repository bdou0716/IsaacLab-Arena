...
def _test_single_compatibility(simulation_app):
    ...
    cameras = [binding for binding in after.observation_bindings if binding.source_term is not None]
    assert cameras and all(binding.robot_key == "robot" for binding in cameras)
