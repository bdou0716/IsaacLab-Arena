...
from isaaclab_arena.utils.instance_rename import (
    active_action_names,
    instance_scene_name,
    rename_instance_cfg,
...
class EmbodimentBase(PlaceableAsset):
    ...
    def get_observation_bindings(self) -> list[ObservationBinding]:
        """Override observation ownership for a robot that composes several members."""
        return []
    ...
    def _rename_cfg(self, cfg: Any, kind: str) -> Any:
        ...
        action_names = active_action_names(self.action_config)
